...
# FOSI_BGC HR (JRA55-forced, single-realization) perfect-model pair -- see
# 3d_models/build_X_Y_from_HR.ipynb. "_interp" (bilinear) is the default X;
# pass --x-path to use the "_avg" (conservative-average) coarsening instead.
...
def extract_candidate_point_timeseries(fields_phys, lat_grid, lon_grid, land_mask_hw, sample_times,
                                        points=None, channel=0, flat_std_tol=1e-6):
    """
