...
#
# MESA-HR twin of submit_stochastic_refine_landthresh_combo.sh:
# STOCHASTIC_REFINE=true + LAND_THRESHOLD=0.5, interp, standard 4-window
# grid.
#
# 1 arm x 4 windows = 4 jobs, into
# results/MESA_stochastic_refine_landthresh_combo/.
#
# Usage:
#   ./submit_stochastic_refine_landthresh_combo_mesa.sh              # dry run
#   ./submit_stochastic_refine_landthresh_combo_mesa.sh --submit      # actually submit
# ==============================================================
...
TEST_YEARS="2021"
BATCH_NAME="MESA_stochastic_refine_landthresh_combo"
...
for train_years in "${SPLITS[@]}"; do
    submit_job "MESA_refine_lt05" "${COMMON},TRAIN_YEARS=${train_years}"
done
