"""
observing_cryosat2_check_v3conservative_sitbiasaug.py

CryoSat-2 comparison for the combined-fixes test: domain-randomization
checkpoint (best training-based fix) run as pure inference against the
conservative-regridded PIOMAS input (best data-pipeline fix) -- see
submit/evaluation/submit_infer_piomas_obs_2020_v3conservative_sitbiasaug.sh.
Identical mechanism to observing_cryosat2_check_v3_conservative.py, just
pointed at this run's eval_data.
"""
...
RUN_DIR = "/glade/work/skygale/_projects/SeaIceDownscaling/Version5/results/PIOMAS_obs_2020/FOSI_sitbiasaug_infer_2020_daily_v3_conservative_5717788.casper-pbs"
